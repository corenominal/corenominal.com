...
<?= $this->section('content') ?>
    ...
    <p>I'm a <?= $age = ((int)date('Y') - 1975) ?> year old tech lover and web developer who spends a lot of time crafting things for the web. When I'm not glued to my desk, you can find me lost in the grimdark future of Warhammer, tackling proud Grumpa duties, listening to tech podcasts, or cycling around town.</p>
